# SHOPIFY-H1-OAUTH-P220
UTC: 2026-08-07T21:49:59Z
...
| `GET` | `https://partners.shopify.com/` | 301→200 | → www partners |
| `GET` | `https://shopify.dev/` | 301→200 | → docs |
...
## Deltas vs P210
- Matrix **stable**: H1+bugbounty 200, OIDC 200, hyphen 404, BC 404, me 401, admin/accounts 403, partners/dev 301.
