# PROTON-F3-DOORS-P198
UTC: 2026-08-07T21:04:23Z
...
| `GET` | `https://account.proton.me/.well-known/openid-configuration` | 200 | OIDC path |
...
| `GET` | `https://bugcrowd.com/h` | 404 | soft path gone this tick |
| `GET` | `https://app.intigriti.com/auth/login` | 200 | adjacent platform login |
...
## Deltas vs P188
- Matrix **stable**: BB 200, account OIDC 200, H1/BC eng 404, auth GET 405, legacy API 404.
- BC `/h` soft **404** this tick (was 200).
