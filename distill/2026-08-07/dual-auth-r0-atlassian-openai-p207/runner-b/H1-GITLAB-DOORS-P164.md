# H1-GITLAB-DOORS-P164
UTC: 2026-08-07T19:55:00Z
...
| `GET` | `https://hackerone.com/gitlab` | 200 | program SPA |
...
## Summary
H2 GitLab bounty SSoT remains **H1 /gitlab** (SPA 200). H1 sign_in/sign_up curl **403**; OIDC+OAuth-AS **200**. GitLab OIDC/JWKS **200**; sign_in **403**; API user/version **401**; public projects **200**. BC eng/gitlab **404**.
...
## Deltas vs P152
- Matrix stable: H1 gitlab 200; gitlab-ce 404; BC 404.
- password/new still 200; OAuth AS still 200.
- api/v4/version **401** (same class as user).
