...
3. Immediately store in 1Password:  
   - Suggested title: `Aiven BB Account A API`  
...
4. Prefer runtime inject: `op run -- env AIVEN_TOKEN=op://… -- curl -H "Authorization: aivenv1 $AIVEN_TOKEN" …`  
