...
### Auth0/CIC — PULSE-72 door refresh
- manage → /login → auth0.auth0.com/authorize (openid profile email + PKCE).
- CIC manage → config.cic-bug-bounty.auth0app.com/authorize; apex ERR.
- RD policy → BC auth0-okta; blog RD still 404.
- bare auth0 404; bare auth0-okta 200; /h + briefs soft-200.
- Artifact: `AUTH0-CIC-DOORS-P72.md` — free tenant + enroll human.

### Aiven — PULSE-74 door refresh
- console login/signup 200; API me/project 401; /h aiven SSoT.
- bare engagements 404; bare brief → /h; programs dead.
- Artifact: `AIVEN-API-DOORS-P74.md` — free-tier human.

### Okta — PULSE-76 door refresh
- First-party BB 404; BC okta+auth0-okta 200; sign_in→identity researcher.
- Artifact: `OKTA-PRODUCT-DOORS-P76.md` — enroll human.

### Atlassian/OpenAI — PULSE-78 door refresh
- BC SSoT both programs; id 202; platform login **403** curl; BB policy path **404**.
- Artifact: `ATLASSIAN-OPENAI-DOORS-P78.md` — enroll human.

### BC platform — PULSE-80 OIDC/docs refresh
- sign_in→identity researcher; login.hackers→/login/hacker; OIDC 200.
- ninja-email + api getting-started SSoT. Artifact: `BC-PLATFORM-OIDC-P80.md`

### PULSE-82 Aiven API doors
- Artifact: `AIVEN-API-DOORS-P82.md` — HEAD 405 / GET 401 on v1 auth endpoints; console + /h SSoT stable.

### PULSE-84 Okta product doors
- Artifact: `OKTA-PRODUCT-DOORS-P84.md` — BC okta/auth0-okta SSoT 200; first-party BB 404; security→trust hop.

### PULSE-86 Atlassian+OpenAI doors
- Artifact: `ATLASSIAN-OPENAI-DOORS-P86.md` — BC SSoT stable; platform login method split; security/ 403; IdP hops.

### PULSE-88 BC platform OIDC
- Artifact: `BC-PLATFORM-OIDC-P88.md` — identity researcher chain; OIDC 200; ninja+API docs SSoT; enroll human.

### PULSE-90 Aiven API doors
- Artifact: `AIVEN-API-DOORS-P90.md` — console+API method split stable; /h SSoT.

### PULSE-101 Okta product doors
- Artifact: `OKTA-PRODUCT-DOORS-P101.md` — Set5 OIDC 200 + me 403; BC okta/auth0-okta SSoT; login.okta OIDC 200; enroll human.

### PULSE-102 Atlassian+OpenAI doors
- Artifact: `ATLASSIAN-OPENAI-DOORS-P102.md` — auth.atlassian OIDC 200; BC dual SSoT; OpenAI API 401/platform 403; human site+TAC.

### PULSE-104 Auth0 CIC doors
- Artifact: `AUTH0-CIC-DOORS-P104.md` — dual UL authorize; CIC+prod OIDC 200; BC SSoT; Get Creds human.

### PULSE-106 BC platform OIDC
- Artifact: `BC-PLATFORM-OIDC-P106.md` — OIDC 200; docs path break → welcome/api SSoT; enroll human.

### PULSE-108 Aiven API doors
- Artifact: `AIVEN-API-DOORS-P108.md` — OIDC+API split; aiven-mbb-og SSoT; free tier human.

### PULSE-110 Okta product doors
- Artifact: `OKTA-PRODUCT-DOORS-P110.md` — stable OIDC+BC SSoT; Set5 MFA human.
