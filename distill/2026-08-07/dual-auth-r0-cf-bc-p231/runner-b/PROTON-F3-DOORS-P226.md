# PROTON-F3-DOORS-P226
UTC: 2026-08-07T22:01:58Z
...
| `GET` | `https://www.protonmail.com/` | 301→200 | → proton.me |
...
## Summary
Proton F3 SSoT **proton.me/security/bug-bounty** **200**. Account login/signup/OIDC **200**. Product shells **200**. H1+BC eng **404**. api auth GET **405**.
...
- www.protonmail.com **301→200** proton.me noted.
